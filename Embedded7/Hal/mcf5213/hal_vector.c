...
extern void canISR_Msg0(void);
extern void canISR_Msg1(void);
extern void _startup(void);

extern unsigned long far __SP_AFTER_RESET[];


typedef void (* vectorTableEntry_t)(void);
...
extern void _startup (void);
__declspec(register_abi) asm void start (void) 
{
_start:
	move.w	#0x2700,sr
	jmp 	_startup
...
/*===============================================
 Externel Interrupt Vector
===============================================*/

#pragma define_section vectortable ".vectorTable" far_absolute RX

/* CF have 255 vector + SP_INIT in the vector table (256 entries)
*/  
__declspec(vectortable) vectorTableEntry_t _interruptVector[256] = {   /* Interrupt vector table */
   (vectorTableEntry_t)__SP_AFTER_RESET,  /*   0 (0x000) Initial supervisor SP      */
...
#ifndef _NO_XHP   
   canISR_Msg0,           /*  87 (0x15C) Device-specific interrupts */
   canISR_Msg1,           /*  88 (0x160) Device-specific interrupts */
#endif
#ifdef _NO_XHP
	asm_exception_handler, asm_exception_handler, /*87, 88, not used */
#endif
   ...
   rubusISR_Timer,           /* 119 (0x___) Reserved                   */
